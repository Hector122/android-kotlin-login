...
class LoginViewModel : ViewModel() {
    ...
    companion object {
        val androidFacts =
            arrayOf("The first commercial Android device was launched in September 2008",
        ...
        val californiaFacts = arrayOf("The most populated state in the United States is California",
